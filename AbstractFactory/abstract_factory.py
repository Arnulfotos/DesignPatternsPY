...
class DesertEnemy(Enemy):
    def attack(self):
        print("Ataque de enemigo con una lanza - 5")


class WaterEnemy(Enemy):
    def attack(self):
        print("Ataque de enemigo con chorro de agua - 5")

class DesertBoss(Boss):
    def attack(self):
        print("Ataque jefe con espada -15")

    def special_attack(self):
        print("Ataque jefe con lluvia de arena -50")


class WaterBoss(Boss):
    def attack(self):
        print("Ataque jefe con aleta -15")

    def special_attack(self):
        print("Ataque jefe con remolino de agua -60")
...
class Game:
    def __init__(self, enemy_factory: EnemiesFactory):
        self.__factory = enemy_factory
